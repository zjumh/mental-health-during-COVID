...
import datetime
data = pd.read_csv("D:\\research\COVID\\text\\result\count\count.csv")
...
c.to_csv("D:\\research\COVID\\text\\result\count\clean_state_count.csv")
data_clean = pd.read_csv("D:\\research\COVID\\text\\result\count\clean_state_count.csv")
data_mental = pd.read_csv("D:\\research\COVID\\text\\result\count\mental_state_month_count.csv")
# preproce the data
...
grid.render("D:\\research\COVID\\text\\photo\geo_heatmap.html")
# plot the map
...
map1.render("D:\\research\COVID\\text\photo\place_photo.html")
